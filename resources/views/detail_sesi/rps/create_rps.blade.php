<div class="modal modal-blur fade" id="add_rps_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Rps Pengantar</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="add_rps_modal_form" action="{{ route('rps.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
