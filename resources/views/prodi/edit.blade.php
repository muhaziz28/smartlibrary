<div class="modal modal-blur fade" id="edit_prodi_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="edit_prodi_modal_form" action="{{ route('prodi.update') }}" method="POST">
                @csrf
                @method('PUT')
